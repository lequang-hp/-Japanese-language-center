...
<body>
    ...
    <!-- header-end -->
        ...
        <div class="bradcam_area breadcam_bg overlay2">
            <h3>Khóa học sắp khai trương</h3>
        </div>
        <!-- bradcam_area_end -->
                    ...
                    <div class="blog_left_sidebar">
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/course2max.jpg" alt="" style="width: 750px;height: 375px;">
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="course_N2.jsp">
                                    <h2>Ôn thi JLPT N2</h2>
                                </a>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/course3max.jpg" alt="" style="width: 750px;height: 375px;">
                                <a href="#" class="blog_item_date">
                                    <h3>17</h3>
                                    <p>Tháng 12</p>
                                </a>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="course_N3.jsp">
                                    <h2>Ôn thi JLPT N3</h2>
                                </a>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> Travel, Lifestyle</a></li>
                                    <li><a href="#"><i class="fa fa-comments"></i> 03 Comments</a></li>
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="img/kaiwa.jpg" alt="" style="width: 750px;height: 375px;">
                                <a href="#" class="blog_item_date">
                                    <h3>20</h3>
                                    <p>Tháng 12</p>
                                </a>
